...
client.on("messageCreate", message => {
    if (message.author.id !== '758987580364292096') return; // التأكد من المستخدم المصرح له
    ...
    if (command.startsWith('!with')) {
        ...
        if (number) {
            ...
            const isAboveLimit = !isAll && parseFloat(number[0]) >= 20e9; // التحقق إذا كان الرقم أكبر من 600e15
            ...
            if (isAll || isAboveLimit) {
                ...
                setTimeout(() => {
                    ...
                    channel.send('!rob 758987580364292096')
                        .then(() => {
