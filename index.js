...
const validChannels = [
  ...
  '1328057861590220841',
  '1328057993085976659'
]; // الشاتات التي يتم فيها التعامل مع !with
...
if (command === "!st") {
    ...
    if (!statusText) {
        return message.reply("⚠️ You need to provide a status text after !st.");
    }
    client.user.setActivity(statusText, { type: "PLAYING" });
    message.reply(`✅ Status updated to: ${statusText}`);
}
});
